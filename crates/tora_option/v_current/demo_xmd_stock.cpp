				    ...
				    CTORATstpRspInfoField *pRspInfoField, int nRequestID)
	{
		if (pRspInfoField->ErrorID == 0)
		{
			...
			***********************************************************************/
			...
			sub_arr_list_sh[0] = (char *)"10004476";
			sub_arr_list_sh[1] = (char *)"10004485";

			// sub_arr_list_sz[0] = (char*)"300750";
			// sub_arr_list_sz[1] = (char*)"123029";

			printf("Start SubscribeMarketData\n");
...
int main(int argc, char *argv[])
{
	...
	if (argc == 1) //默认TCP连接仿真环境
	{
		...
		// strcpy(XMD_TCP_FrontAddress, "tcp://210.14.72.16:9402");
		strcpy(XMD_TCP_FrontAddress, "tcp://10.188.80.26:15402");
		// strcpy(XMD_TCP_FrontAddress,"tcp://210.14.72.17:15402");
	}
